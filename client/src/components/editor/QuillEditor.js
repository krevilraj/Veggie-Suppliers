...
class QuillEditor extends React.Component {
  ...
  constructor(props) {
    ...
    this.state.editorHtml = props.htmlval;
        ...
        .then(response => {
          if (response.data.success) {
            ...
            quill.insertEmbed(position, "image", {
              src: "http://localhost:5000/" + response.data.image,
    ...
    return (
      <div>
        ...
        <ReactQuill
          ...
          style={{"height": "271px"}}
        />
        <input type="file" accept="image/*" ref={this.inputOpenImageRef} style={{display: "none"}}
               onChange={this.insertImage}/>
        <input type="file" accept="video/*" ref={this.inputOpenVideoRef} style={{display: "none"}}
