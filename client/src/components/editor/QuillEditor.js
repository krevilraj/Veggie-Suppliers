            ...
            axios.post('/api/product/uploadImage', formData, config)
                .then(response => {
                    if (response.data.success) {
                        ...
                        quill.insertEmbed(position, "image", { src: "http://localhost:5000/" + response.data.image, alt: response.data.fileName });
            ...
            axios.post('/api/product/uploadImage', formData, config)
                .then(response => {
                    if (response.data.success) {
                        ...
                        let range = quill.getSelection();
                        let position = range ? range.index : 0;
                        quill.insertEmbed(position, "video", { src: "http://localhost:5000/" + response.data.image, title: response.data.fileName });
                        quill.setSelection(position + 1);
